...
plt.legend(loc='best')
plt.xlabel(r'$r \:/\: \text{m}$')
plt.ylabel(r'$B  \:/\: \text{T}$')
...
plt.xlabel(r'$\frac{1}{B} \:/\: \frac{1}{\text{T}}$')
plt.ylabel(r'$T^2 \:/\: \text{s}^2$')
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
...
plt.legend(loc='best')
plt.xlabel(r'$B \:/\: \text{T} $')
plt.ylabel(r'$\frac{1}{T} \:/\: \frac{1}{\text{s}}$')
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
